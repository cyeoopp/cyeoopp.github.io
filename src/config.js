const config = {
	...
	polarChart: {
		...
		skillPoints: [45.7854, 33.4888, 54.4233, 100, 34.2296, 26.1481, 55.9247],
	},
	...
	//打字机
	typeWriterStrings: [
		"我发现，99%的社交对话可通过‘确实’、‘好吧’、‘我看一下’应答，剩下的1%则需要我投入99%的精力去寻找合适的表达方式。",
		"我喜欢独处，虽然物质生活并不丰富，但精神世界却宽广无垠，在那里我可以自由地探索和创造。",
		"心灵的共鸣胜过其他一切交流方式，也是我一直都在寻找的东西。",
		"为了寻找真正的共鸣，我愿意打破我的常规，去表达我内心真实的想法和感受。",
		"朋友不在于多少，而在于是否能真正理解你。对于我来说，能够找到几个真正的朋友，是我目前最幸运的事。",
		"在这个世界上，最遥远的距离不是生与死，而是我在你面前，你却不知道我喜欢你。",
	...
	musicPlayer: {
		...
		type: 'playlist',   //歌单类型
		id: '17791315120'  //歌单id ---> music.163.com/#/playlist?id=3220609230
	},
	...
	projectcards: [
		...
		},
		{
			...
			title: "改进论文（进行中）",
			subtitle: "进行中",
			text: "论文改进与完善中，当前focus在引入更多相关工作和丰富实验结果上，敬请期待最终版本！",
			url: "https://github.com/cyeoopp/chieoppu_scuba",
			show: false
		},
	],
